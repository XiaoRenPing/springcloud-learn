    ...
    <link href="${pageContext.request.contextPath }/style/css/font-awesome.min.css?v=4.3.0" rel="stylesheet">
    ...
    <link href="${pageContext.request.contextPath }/style/css/plugins/sweetalert/sweetalert.css" rel="stylesheet"> --%>
