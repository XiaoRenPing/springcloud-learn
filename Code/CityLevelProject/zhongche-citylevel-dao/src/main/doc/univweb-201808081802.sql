...
/*Table structure for table `bi_leave` */

DROP TABLE IF EXISTS `bi_leave`;

CREATE TABLE `bi_leave` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Name` varchar(100) DEFAULT NULL COMMENT '请假条名称(标题)',
  `Content` varchar(200) DEFAULT NULL COMMENT '内容说明',
  `Description` varchar(100) DEFAULT NULL COMMENT '请假原由',
  `Applyer` varchar(62) DEFAULT NULL COMMENT '申请人',
  `ApplyUserId` bigint(20) DEFAULT NULL COMMENT '申请人id',
  `ReceiveUserId` bigint(20) DEFAULT NULL COMMENT '受理人id',
  `CreationTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '申请日期',
  PRIMARY KEY (`Id`)
...
CREATE TABLE `sys_config` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ApplicationName` varchar(100) DEFAULT NULL COMMENT '网站名称',
  `Keyword` varchar(200) DEFAULT NULL COMMENT '搜索关键字',
  `Content` varchar(200) DEFAULT NULL COMMENT '站点内容描述',
...
CREATE TABLE `sys_permissions` (
  ...
  `IsGranted` tinyint(1) DEFAULT NULL COMMENT '是否授权',
  `CreationTime` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `CreatorUserId` bigint(19) DEFAULT NULL,
  `RoleId` bigint(19) DEFAULT NULL COMMENT '关联角色',
  `UserId` bigint(19) DEFAULT NULL COMMENT '关联用户',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sys_user_roles` (
  `Id` bigint(19) NOT NULL AUTO_INCREMENT,
  `UserId` bigint(19) NOT NULL COMMENT '关联用户',
  `RoleId` int(10) NOT NULL COMMENT '关联角色',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户角色多对多关联中间表';
