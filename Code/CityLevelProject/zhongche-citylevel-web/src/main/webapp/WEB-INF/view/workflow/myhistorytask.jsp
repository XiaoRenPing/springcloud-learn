...
<div id="vue-taskList">
	<table>
		...
		<tr v-for="task in taskList">
			...
			<td  id="dealwith"><a v-bind:href="'http://127.0.0.1:8081/univweb-rpym-web/dealwithapply.jsp?taskId='+task.id">审批</a></td>
		</tr>
	</table>
</div>
...
<script>
   ...
   var f1=  new Vue({
        ...
        created:function () { //created方法，页面初始调用   
        	var page = 1;
        	var rows = 1;
            var url = "http://127.0.0.1:8081/univweb-rpym-web/workflow/myhistorytask?page="+page+"&rows="+rows;
