...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/style/lui/js/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/style/lui/css/font-awesome.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/style/lui/css/index.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/style/lui/css/skins/_all-skins.css">
</head>
<body class="hold-transition skin-blue sidebar-mini" style="overflow:hidden;">
    ...
    <script src="${pageContext.request.contextPath }/style/lui/js/jquery/jQuery-2.2.0.min.js"></script>
    <script src="${pageContext.request.contextPath }/style/lui/js/bootstrap/js/bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath }/style/lui/js/index.js"></script>
</body>
</html>
